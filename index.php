        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <h5 class="font-white space-xs" style="font-size: 2.25rem; font-family: 'FontAwesome', cursive;">Tìm nhà hàng, món ....</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">Tôi muốn ....</label>
                                <div class="form-group">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choise Restaurant</h4> </div>
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Order Food/Drink</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Món được chọn nhiều trong tuần</h2>
                    <p class="lead">Cách dễ nhất chọn món ngon không cần suy nghĩ</p>
                </div>
                <div class="row">
						<?php
                            ...
                            echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                    <div class="food-item-wrap">
                                        <div class="figure-wrap bg-image" data-image-src="admin/Res_img/dishes/'.$r['img'].'">
                                            <div class="distance"><i class="fa fa-pin"></i>700m</div>
                                            <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                                            <div class="review pull-right"><a href="#">222 reviews</a> </div>
                                        </div>
                                        <div class="content">
                                            <h5><a href="dishes.php?res_id='.$r['rs_id'].'">'.$r['title'].'</a></h5>
                                            <div class="product-name">'.$r['slogan'].'</div>
                                            <div class="price-btn-block"> <span class="price">'.$r['price'].'k</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Đặt món ngay</a> </div>
                                        </div>
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2>3 cách đơn giản để có món ngon</h2>
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Chọn cửa hàng</h3>
                                    <p>Với thực đơn từ hơn 200 cửa hàng, địa điểm ăn uống giao hàng trực tuyến ở Nha Trang.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Chọn món ưa thích</h3>
                                <p>Với các món ăn đặc sắc được cập nhật hàng ngày và hàng giờ.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Giao hàng hoặc đặt giữ</h3>
                                <p>Tiến hành đặt hàng nào và chờ trong vòng 15 phút. Những món ăn sẵn sàng chờ bạn</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Nhân viên Thi Đà đã được trợ giá 20% bởi phúc lợi của công ty.</p>
                    </div>
                </div>
            </div>
        </section>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                            ...
                                            <div class="bottom-part">
                                                <div class="cost"><i class="fa fa-check"> Tối thiểu 70k</i> </div>
                                                <div class="mins"><i class="fa fa-motorcycle"></i> 15 phút</div>
